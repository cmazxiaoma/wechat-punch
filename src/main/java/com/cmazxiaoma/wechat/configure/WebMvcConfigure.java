...
import com.cmazxiaoma.wechat.core.ResultCode;
import com.cmazxiaoma.wechat.core.ServiceException;
        ...
        exceptionResolvers.add(new HandlerExceptionResolver() {
            public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception e) {
                ...
                if (e instanceof ServiceException) {
                    ...
                    resultVO = resultVOBuilder.code(ResultCode.NOT_FOUND.getCode()).msg("接口 [" + request.getRequestURI() + "] 不存在").build();
                } else if (e instanceof ServletException) {
                    resultVO = resultVOBuilder.code(ResultCode.FAIL.getCode()).msg(e.getMessage()).build();
                } else {
                    resultVO = resultVOBuilder.code(ResultCode.INTERNAL_SERVER_ERROR.getCode()).msg("接口 [" + request.getRequestURI() + "] 内部错误，请联系管理员").build();
                    String message;
