...
public class WxCallBackController extends BaseController {
    ...
    @GetMapping()
    public ModelAndView doGetCallBack() throws UnsupportedEncodingException {
        //用户同意授权之后，获得code
        ...
        return new ModelAndView(new RedirectView("http://majinlan.tunnel.echomod.cn/punchCard/homePage.html?openid=" + openid + "&nick_name=" + URLEncoder.encode(nickName, "UTF-8")));
    }
